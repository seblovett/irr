...
%  <+Last Edited: Sat 22 Mar 2014 16:06:06 GMT by seblovett on seblovett-Ubuntu +>
...
This current is the sub-threshold current an occurs when the transistor is off and is also exponentially dependant on $V_{th}$ \cite{borkar1999design}.
