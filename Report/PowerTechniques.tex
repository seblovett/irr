...
%  <+Last Edited: Wed 30 Apr 2014 09:32:57 BST by seblovett on seblovett-Ubuntu +>
...
This is seen in Firgue~\ref{fig:scpg:iso}.
...
\todo[inline]{Could be better to have the isolation / gating circuit instead of the clock gating with AND gate.}s
\begin{figure}
